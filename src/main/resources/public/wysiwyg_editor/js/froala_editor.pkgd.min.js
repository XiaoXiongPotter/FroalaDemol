...
! function (a) {
    ...
    if (b.DEFAULTS = {
        ...
        function i(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild; i;) {
                    ...
                    else if ("BR" == i.tagName) null == g ? (g = b.doc.createElement(e), d && g.setAttribute("data-empty", !0), g.appendChild(i), f.appendChild(g)) : !1 === h && (g.appendChild(b.doc.createElement("br")), g.setAttribute("data-empty", !0)), g = null;
                    else {
                        var k = i.textContent;
        ...
        function m(a) {
            if (a.lengthComputable) {
                f("Uploading", a.loaded / a.total * 100 | 0)
            }
        }
        ...
        function m(c) {
            ...
            if ("mousedown" == c.type) {
                ...
                g.location != g.parent.location && g.frameElement && (d += b.helpers.getPX(a(g.frameElement).offset().left) + g.frameElement.clientLeft)
            }
            ...
            if (b.opts.imageResizeWithPercent) {
                ...
                xa.css("width", (h / a(i).outerWidth() * 100).toFixed(2) + "%")
            } else xa.css("width", h);
        ...
        function D(a) {
            if (a.lengthComputable) {
                t("Uploading", a.loaded / a.total * 100 | 0)
            }
        }
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
            ...
            function r(f, g, h) {
                ...
                var k, l = c();
                if (l) k = a(l), k.attr("href", f), g.length > 0 && k.text() != g && !i && k.text(g), i || k.prepend(a.FE.START_MARKER).append(a.FE.END_MARKER), k.attr(h), i || b.selection.restore();
                else {
                    ...
                    for (var m = d(), n = 0; n < m.length; n++) k = a(m[n]), k.attr(h), k.removeAttr("_moz_dirty");
                    1 == m.length && b.$wp && !i && (a(m[0]).prepend(a.FE.START_MARKER).append(a.FE.END_MARKER), b.selection.restore())
                } if (i) {
        ...
        a.FE.RegisterCommand("linkRemove", {
                ...
                b.events.$on(l, "keydown", function (c) {
                    ...
                    if (d == a.FE.KEYCODE.TAB || d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT) {
                        var g = null,
                            h = null,
                            j = !1;
                        return d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT ? (h = d == a.FE.KEYCODE.ARROW_RIGHT, j = !0) : h = !c.shiftKey, f.length ? (j && (g = h ? f.nextAll("span.fr-special-character:first") : f.prevAll("span.fr-special-character:first")), g && g.length || (g = h ? f.parent().next().find("span.fr-special-character:first") : f.parent().prev().find("span.fr-special-character:" + (j ? "last" : "first")), g.length || (g = l.find("span.fr-special-character:" + (h ? "first" : "last"))))) : g = l.find("span.fr-special-character:" + (h ? "first" : "last")), e(g, c), !1
                    }
            ...
            function f(b) {
                b.which == a.FE.KEYCODE.ENTER && setTimeout(i.reloadMarkup, 0)
            }
            ...
            function h() {
                ...
                a.container = b.$el.get(0), a.autoStartup = b.opts.scaytAutoload, null !== b.opts.language && (b.opts.spellCheckerLanguage = b.opts.language), !0 === b.opts.scaytAutoload && (b.opts.spellcheck = !1), b.events.on("commands.before", d), b.events.on("commands.after", e), b.events.on("keydown", f, !0);
            ...
            function D() {
                if (1 == sa().length) {
                    ...
                    if (d > 1) {
                        ...
                        f = f / e * 100 / 2,
                            c.css("width", f.toFixed(4) + "%"), g.css("width", f.toFixed(4) + "%")
                    }
            ...
            function c(a, c, d) {
                var e = d;
                return /^((http|https|ftp|ftps)\:\/\/)/i.test(e) || (e = "//" + e), (c || "") + "<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (h ? ' rel="' + h + '"' : "") + ' href="' + e + '">' + d + "</a>"
            }
            ...
            function e(a) {
                return b.opts.linkAlwaysNoFollow && (h = "nofollow"), b.opts.linkAlwaysBlank && (h ? h += " noopener noreferrer" : h = "noopener noreferrer"), a.replace(d(), c)
            }
            ...
            function g() {
                b.events.on("paste.afterCleanup", function (b) {
                    ...
                    if (c.which == a.FE.KEYCODE.ENTER) {
                        var d = b.selection.element();
                        if (("A" == d.tagName || a(d).parents("a").length) && b.selection.info(d).atEnd) return c.stopImmediatePropagation(), "A" !== d.tagName && (d = a(d).parents("a")[0]), a(d).after("&nbsp;" + a.FE.MARKERS), b.selection.restore(), !1
                    }
                })
            }
            var h = null;
            ...
            function y(a) {
                if (a.lengthComputable) {
                    p("Uploading", a.loaded / a.total * 100 | 0)
                }
            }
            ...
            function B(c) {
                ...
                if ("mousedown" == c.type) {
                    ...
                    h.location != h.parent.location && h.frameElement && (d += b.helpers.getPX(a(h.frameElement).offset().left) + h.frameElement.clientLeft, e = c.clientY + b.helpers.getPX(a(h.frameElement).offset().top) + h.frameElement.clientTop)
                }
            ...
            callback: function () {
                ...
                this.video.get() || this.opts.toolbarInline ? (a.removeClass("fr-hidden"), a.next(".fr-separator").removeClass("fr-hidden")) : (a.addClass("fr-hidden"),
